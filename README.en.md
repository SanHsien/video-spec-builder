...
> Maintenance fork of [`feicaiclub/video-spec-builder`](https://github.com/feicaiclub/video-spec-builder) focused on Windows-first developer experience, automated quality gates, and upstream tracking. See [`FORK.md`](FORK.md) for maintenance decisions.
